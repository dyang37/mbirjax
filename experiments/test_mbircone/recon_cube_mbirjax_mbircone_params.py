...
if __name__ == "__main__":
    ...
    save_path = f'output/3D_cube_mbirjax_with_mbircone_params/'
    ...
    pu.slice_viewer(sinogram_mbircone, sinogram_mbirjax, title='Sinogram MBIRCONE (left) vs Sinogram MBIRJAX (right)', slice_label='View', slice_axis=0)
    pu.slice_viewer(diff_sinogram, title='Sinogram differene (sino_mbirjax - sino_mbircone)', slice_label='View', slice_axis=0, vmin=-0.08, vmax=0.08)
    ...
    time0 = time.time()
    recon, recon_params = ct_model.recon(sinogram_mbirjax, weights=weights, num_iterations=15)
    ...
    # load MBIRCONE recon for comparison
    recon_mbircone = np.load("output/3D_cube_mbircone/recon.npy")

    pu.slice_viewer(recon_mbircone, recon, title='MBIRCONE recon (left) vs MBIRJAX recon (right)', slice_axis=0, slice_label='Axial Slice', vmin=0, vmax=0.2)
    pu.slice_viewer(recon_mbircone, recon, title='MBIRCONE recon (left) vs MBIRJAX recon (right)', slice_axis=1, slice_label='Coronal Slice', vmin=0, vmax=0.2)
