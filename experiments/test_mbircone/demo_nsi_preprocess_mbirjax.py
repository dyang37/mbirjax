...
if __name__ == "__main__":
    ...
    save_path = f'output/nsi_datasets/mar_metal_vert_ds2' # change this for different datasets
    os.makedirs(save_path, exist_ok=True)
    
    # path to NSI dataset
    dataset_path = "/depot/bouman/data/share_conebeam_data/new_MAR_phantom/vert_metal_with_corrections"
    ...
    geom_report_path = os.path.join(dataset_path, 'Geometry Report [JB-033_ArtifactPhantom_Vertical_NoMetal].rtf')
    ...
    # #### Parameters specific to the down-sampling of sinogram data
    ...
    # Display results
    pu.slice_viewer(recon, vmin=0, vmax=0.015, slice_axis=0, slice_label='Axial Slice', title='MBIRJAX recon')
    pu.slice_viewer(recon, vmin=0, vmax=0.015, slice_axis=1, slice_label='Coronal Slice', title='MBIRJAX recon')
    pu.slice_viewer(recon, vmin=0, vmax=0.015, slice_axis=2, slice_label='Sagittal Slice', title='MBIRJAX recon')
